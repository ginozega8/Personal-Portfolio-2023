          ...
          <div className='w-[80vw] sm:w-[60vw] ml-5 sm:ml-[20vw] sm:pt-[20vh] pt-[5vh]'>
            <div className="glitch-wrapper">
              ...
              <div className='flex flex-col sm:flex-row'>
                <a className='text-text-1-gray text-left pt-5 text-[17px] font-bold hover:text-text-soft-yellow duration-500 cursor-pointer'>Read more about me <span className='text-[20px] pl-2'>→</span></a>
