...
function about() {
    return (
        <div>
            <Navbar />
            <h2 className={"text-text-soft-yellow text-[35px] font-bold tracking-[3px] pt-[10vh] pb-[50px] text-center"}>MYSELF</h2>
            <div>
                <p className='text-text-1-gray text-center xl:mx-[30vw]'>I'm a 23-year-old web developer from Argentina with a passion for technology. My journey into the world of web development began in 2021, and by 2022, I was already working in the field as a freelancer. Since then, every day I have found immense satisfaction in the process of coding, experimenting, sharing, and learning new things.
                </p>
                
            </div>
            <div className={"flex flex-col justify-center items-center space-y-2"}>
                <h2 className={"text-text-soft-yellow text-[35px] font-bold tracking-[3px] pt-[10vh] pb-[30px] text-left"}>MY EXPERIENCE</h2>
